      ...
      <aside style={{
        ...
        <div style={{ padding: '0 24px', marginBottom: 32 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{
              width: 40, height: 40, background: '#00236f',
        ...
        <header style={{
          ...
          <div style={{ position: 'relative', width: 360 }}>
            <span className="material-symbols-outlined" style={{
              ...
              color: '#757682', fontSize: 18
            }}>search</span>
            <input placeholder="Search students, seats, fees..." style={{
              width: '100%', padding: '8px 12px 8px 36px',
              background: '#f4f3fa', border: '1px solid #e3e1e9', borderRadius: 4,
              fontSize: 13, fontFamily: 'Newsreader, serif', fontStyle: 'italic',
              outline: 'none'
            }} />
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div style={{
              width: 36, height: 36, borderRadius: '50%', background: '#dce1ff',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 14, fontWeight: 700, color: '#00236f'
            }}>
